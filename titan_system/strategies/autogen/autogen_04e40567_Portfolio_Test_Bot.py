...
=========================
Strategy: Portfolio Test Bot
Type: Mean Reversion
Generated: 2026-01-15 00:13:21
Source Genome ID: 04e40567-1da9-4265-baaf-73782a0a8a0f
...
logger = logging.getLogger("Portfolio Test Bot")
...
def calculate_position_size(entry, sl):
    ...
    pm = PortfolioManager()
    return pm.calculate_optimal_size("04e40567-1da9-4265-baaf-73782a0a8a0f", SYMBOL, entry, sl)
...
def main():
    """Main bot loop."""
    logger.info("=" * 60)
    logger.info(f"Bot: Portfolio Test Bot")
