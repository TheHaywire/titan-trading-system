...
console = Console()
strategies = [cls() for cls in PROFESSIONAL_BATCH4]

console.print(f"\n[bold cyan]PROFESSIONAL BATCH 4: {len(strategies)} strategies[/bold cyan]")
console.print(f"[bold yellow]SMC, exotic indicators, advanced MTF[/bold yellow]\n")

results_table = Table(title="Batch 4 Results")
